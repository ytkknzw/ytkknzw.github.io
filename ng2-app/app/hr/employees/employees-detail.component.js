...
var EmployeesDetailComponent = (function () {
    function EmployeesDetailComponent(route, location, empService, appSvc) {
        this.route = route;
    ...
    EmployeesDetailComponent.prototype.goBack = function () {
        this.location.back();
    };
    ...
    ], EmployeesDetailComponent.prototype, "employee", void 0);
...
exports.EmployeesDetailComponent = EmployeesDetailComponent;
